...
Yaitu type data berupa logika. Nilainya terdiri dari `TRUE` atau `FALSE`. Type data ini umumnya digunakan untuk mengecek kondisi tertentu baik bernilai benar (`TRUE`) atau salah (`FALSE`).
Contoh:
