...
R itu cukup populer, apabila di lihat ranking popularitas Bahasa pemrograman di TIOBE INDEX, R konsisten berada di jajaran 20 besar. Ini artinya, segmen pengguna R itu cukup besar. 
...
Saya rasa, ini sah – sah saja ya. Namun, jika kalian hanya menggunakan R untuk problem solving kalian tanpa tahu basiknya, kalian sangat rentan dengan masalah. Misalnya, ketika ketemu bugs dalam program kalian yang kalian buat, kalian akan sulit mendeteksinya dan ini bisa bikin frustasi. 
